...
import za.co.commspace.auth.Authentication;
import za.co.commspace.auth.HttpBasicAuth;
import za.co.commspace.auth.ApiKeyAuth;
import za.co.commspace.auth.OAuth;

@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2021-09-15T08:32:32.372Z[GMT]")public class ApiClient {
  protected Map<String, String> defaultHeaderMap = new HashMap<String, String>();
  protected String basePath = "https://qaapi.commspace.co.za";
  ...
  public ApiClient() {
    ...
    setUserAgent("Swagger-Codegen/1.1.2/java");
